...
public class Verbs
{
    ...
    private static String ACTIVITY_STREAM_URI = "http://activitystrea.ms/schema/1.0/";
    ...
    private static Verb createActivityStreamsVerb(String id, String display)
    {
        Verb v = new Verb();
        HashMap<String, String> descriptions = new HashMap<String, String>();
        descriptions.put("en-GB", display);
        v.setId(ACTIVITY_STREAM_URI + id);
        v.setDisplay(descriptions);
        return v;
    }
    ...
    public static Verb searched()
    {
        return createActivityStreamsVerb("search", "searched");
    }
